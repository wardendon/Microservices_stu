...
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='积分变更记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户-分享中间表【描述用户购买的分享】';
...
CREATE TABLE `share` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=133 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分享表';
...
INSERT INTO `user` VALUES (2, '13951901489', '123123', '陶然然', 'user', 'https://tva1.sinaimg.cn/large/e6c9d24egy1h5t7dsufq9j20ku0j9gno.jpg', '2022-09-03 12:23:50', '2022-09-03 16:23:50', 200);
COMMIT;
